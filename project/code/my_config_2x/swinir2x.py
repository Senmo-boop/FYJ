...
data = dict(
    ...
    train=dict(
        ...
        lq_folder='../datasets/train/train dataests/LR2x',
        gt_folder='../datasets/train/train dataests/HR2x',
        pipeline=train_pipeline,
        scale=scale,
        filename_tmpl='{}'),
    val=dict(
        type=val_dataset_type,
        lq_folder='../datasets/val/val dataests/LR2x',
        gt_folder='../datasets/val/val dataests/HR2x',
        pipeline=test_pipeline,
        scale=scale,
        filename_tmpl='{}'),
    test=dict(
        type=val_dataset_type,
        lq_folder='../datasets/test/test dataests/LR2x',
        gt_folder='../datasets/test/test dataests/HR2x',
        pipeline=test_pipeline,
        scale=scale,
        filename_tmpl='{}'))
