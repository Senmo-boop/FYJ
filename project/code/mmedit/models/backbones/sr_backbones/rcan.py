...
class RCAN(nn.Module):
    def __init__(self, n_resgroups, n_resblocks, n_feats, reduction, scale, n_colors=3):
        ...
        modules_body = [
            ResidualGroup(
                default_conv, n_feats, kernel_size, reduction, act=act, n_resblocks=n_resblocks) \
