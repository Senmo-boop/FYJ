...
def parse_args():
    ...
    parser.add_argument('--config', default='../my_config_div_flickr/swinir_all4x.py', help='test config file path')
    parser.add_argument('--checkpoint', default='../work_dirs_div_flickr/swinir_all4x/iter_20000.pth',  help='checkpoint file')
