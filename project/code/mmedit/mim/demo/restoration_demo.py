...
def parse_args():
    ...
    parser.add_argument('--config',
                        default="../work_dirs_2x/swinir_all2x/swinir_all2x.py",
                        help='test config file path')
    parser.add_argument('--checkpoint',
                        default="../work_dirs_2x/swinir_all2x/iter_50000.pth",
                        help='checkpoint file')
    parser.add_argument('--img_path_dir', default="../datasets/test/LRx2",
                        help='path to input image file')
    parser.add_argument('--save_path_dir', default="../datasets/pred",
