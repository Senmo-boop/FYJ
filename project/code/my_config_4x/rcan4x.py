...
data = dict(
    ...
    train=dict(
        ...
        lq_folder='../datasets/train/train dataests/LR4x',
        gt_folder='../datasets/train/train dataests/HR4x',
        pipeline=train_pipeline,
        scale=scale,
        filename_tmpl='{}'),
    val=dict(
        type=val_dataset_type,
        lq_folder='../datasets/val/val dataests/LR4x',
        gt_folder='../datasets/val/val dataests/HR4x',
        pipeline=test_pipeline,
        scale=scale,
        filename_tmpl='{}'),
    test=dict(
        type=val_dataset_type,
        lq_folder='../datasets/test/test dataests/LR4x',
        gt_folder='../datasets/test/test dataests/HR4x',
        pipeline=test_pipeline,
        scale=scale,
        filename_tmpl='{}'))
